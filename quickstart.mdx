...
- A Send account and access to program IDs (contact support if needed)

## Installation

1. Import the SendUnitySDK package into your Unity project via the Package Manager:
   - Window > Package Manager > + > Add package from git URL
   - Enter: `https://github.com/send-io/unity-sdk.git`
...
3. Configure your SDK settings in the inspector:
   - Enter your RPC endpoint URL (e.g., `https://api.devnet.send.io`)
...
See our [full documentation](https://docs.send.io) for more details.

## Troubleshooting

Common issues:
- Authentication failures: Check your RPC endpoint and network status
- Transaction errors: Verify program IDs and contract addresses
- Gas/fee issues: Ensure your game wallet has sufficient balance

For support, join our [Discord community](https://discord.gg/send) or email support@send.io